...
export const LIVESTOCK_DATA: Livestock[] = [
  {
    id: '1',
    name: '苏尼特羊',
    typeId: '1',
    ...
    monthlyFeedFee: 150,
    redemptionMonths: 12,
    description: '纯正草原血统，肉质鲜嫩，生长周期12个月。',
    images: ['https://images.unsplash.com/photo-1524024973431-2ad916746881?auto=format&fit=crop&q=80&w=800'],
    mainImage: 'https://images.unsplash.com/photo-1524024973431-2ad916746881?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    monthlyFeedFee: 30,
    redemptionMonths: 6,
    description: '林间散养，五谷喂养，产蛋率高，肉质紧实。',
    images: ['https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&q=80&w=800'],
    mainImage: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    monthlyFeedFee: 80,
    redemptionMonths: 12,
    description: '珍稀品种，营养价值极高，孵化周期42天。',
    images: ['https://images.unsplash.com/photo-1516467508483-a7212febe31a?auto=format&fit=crop&q=80&w=800'],
    mainImage: 'https://images.unsplash.com/photo-1516467508483-a7212febe31a?auto=format&fit=crop&q=80&w=800',
